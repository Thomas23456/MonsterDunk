...
<html lang="fr">
    ...
    <div id="globalMatch">
		...
		<nav>
            ...
            <div id="conteneurPageMatch">
                <div id="conteneurMatch">
                    <div id="conteneurTitreMatch">
                        <h2>Calendrier de match</h2>
                    </div>
                    <div id="listeMatch">
                        <p>La saison NBA 2019-20 est suspendue pour cause de COVID-19</p>
                    </div>
                </div>
            </div>
