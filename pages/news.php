...
<body>
	...
	<div class="containerNews">
		<div class="imageNews">
			<img src="../images/articles/article1.jpg" alt="Logo équipe celtics"/>
		</div>
		<div class="containerInfosNews">
			<div class="newsType">News</div>
			<div class="newsTitre">Lebron James vs Stephen Curry : une bataille sans merci</div><br/>
			<div>Lorem ipsum ma foi on verra bien ce qu'on mettra quand ce sera l'heure de le faire ne penses-tu pas mon petit ?</div>
			<div class="newsEditeur"><div>par BasketSession, 12/06/2020</div></div>
		</div>
	</div><br/>
